...
img = Image.open('favicon.jpeg')

st.set_page_config(page_title='VisionX', page_icon=img)
...
def main():
    ...
    input_source = st.sidebar.radio(
     "Select input source",
     ('Local video', 'Webcam', 'Real Time Streaming Platform'))
    ...
    # -------------------------- RTSP ------------------------------
    if input_source == "Real Time Streaming Platform":
